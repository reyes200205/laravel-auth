            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white border border-gray-200 overflow-hidden shadow-sm rounded-2xl p-6 relative">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="w-12 h-12 rounded-xl bg-indigo-600 flex items-center justify-center text-white shadow-md font-bold text-xl">
                            {{ user.name[0] }}
                        </div>
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">
                                Correo: <span class="font-medium text-gray-700">{{ user.email }}</span> &bull; Rol asignado: <span class="font-semibold text-indigo-600 uppercase">{{ user.role }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <!-- KPI 1: Usuarios -->
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all duration-200">
