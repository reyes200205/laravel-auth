...
## Fase 1: Autenticación Básica (Login Estándar) : Guest
...
- **Caso 2.3: Código OTP incorrecto o expirado**
    ...
    - **Resultado esperado:** Mensaje de error: _"El código ingresado es inválido o ha expirado."_ El intento se registra en el log.
